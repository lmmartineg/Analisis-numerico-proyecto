function [X_Nuevo,Tabla_resultados] = Regla_Falsa(Funcion,Intervalo,Tolerancia,Num_Max_iteraciones)
...
if F_A<F_B && F_A*F_B<0
    fprintf('el intervalo entregado es valido')
else
    fprintf('el intervalo entregado no es valido')
end
if F_A==0
    fprintf('su funcion tiene una raiz en %f',a)
end
if F_B==0
    fprintf('su funcion tiene una raiz en %f',b)
end
